...
extern Fp64 fp64_sqrt(Fp64 f, uint32_t iterations);
...
public:
	...
	//#Javier For easier constructor/assignment
	inline Fp64(int64_t i)
	{
		Fp64(fpc::fp64_from_i64(i));
	}

	inline Fp64(double d)
	{
		Fp64(fpc::fp64_from_f64(d));
	}
	//#Javier
	...
	inline static Fp64 Sqrt(Fp64 F, uint32_t Iterations) 
	{
		return Fp64(fpc::fp64_sqrt(F.m_Internal, Iterations));
	}
