...
Circle::Circle(math::Vector2 pos, decimal rot, math::Vector2 vel, decimal angVel, decimal mass,  decimal e, bool isKinematic,
	decimal rad)
	: Rigidbody(pos, rot, vel, angVel, mass, e, isKinematic), m_radius(rad)
{
