...
bool Capsule::ComputeIntersect(Rigidbody* rb2, decimal dt)
{
	return rb2->IntersectWith(this, dt);
}

bool Capsule::IntersectWith(Circle* rb2, decimal dt)
{
	return false;
}

bool Capsule::IntersectWith(Capsule* rb2, decimal dt)
{
	return false;
}
